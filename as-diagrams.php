...
@version 1.0.11
@last_modified 16.01.2007 (dd.mm.yyyy)
@Author Alexander Selifonov,  http://as-works.narod.ru
@comment Please read "as-diagrams.htm" for detailed instructions
============================================================================
*/
$css_drawn = 0;
class CAsBarDiagram
...
//   $pc = $bar[$iy]; // todo - $iy % count($bar);
      ...
      echo "<td align=right nowrap><b>&nbsp; &nbsp;</b></tr>\n";
